...
async function removeStudent(courseId, studentId) {
  ...
  for(let student of tempCourse.students)  {
    ...
    if(student == studentId)  {
      ...
      if(tempCourse.students.length == 1)
        tempCourse.students.pop();
...
async function removeTeacher(courseId, teacherId) {
  ...
  for(let teacher of tempCourse.teachers)  {
    ...
    if(teacher == teacherId)  {
      ...
      if(tempCourse.teachers.length == 1)
        tempCourse.teachers.pop();
...
module.exports = {
  createCourse, addTeacher, addStudent, removeStudent, removeTeacher
};
